...
MainMenu::MainMenu(std::shared_ptr<Context> &context)
	: m_context(context), m_isPlayButtonSelected(true), m_isPlayButtonPressed(false), m_isExitButtonSelected(false), m_isExitButtonPressed(false)
{
...
void MainMenu::Init() {
	...
	m_context->m_assets->AddFont(MAIN_FONT, "Assets/fonts/AmaticB.ttf");

	//TITLE
	m_gameTitle.setFont(m_context->m_assets->GetFont(MAIN_FONT));
	m_gameTitle.setString("THE EXCOLO GAME!!");
